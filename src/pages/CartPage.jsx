...
export default function CartPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] font-sans">
      ...
      {/* Banner */}
      <div
        className="relative w-full h-36 flex flex-col items-center justify-center overflow-hidden"
      ...
      >
        ...
        <h1 className="font-serif text-[#3d1a1a] text-3xl font-semibold z-10">My Cart</h1>
